...
import { useBanxSolBalance, useDiscordUser, useSolanaBalance } from '@coopfi/hooks'
import { BanxSOL, ChangeWallet, Copy, SignOut } from '@coopfi/icons'
import { AssetMode, useAssetMode, useIsLedger, useTokenType } from '@coopfi/store/common'
import {
  copyToClipboard,
