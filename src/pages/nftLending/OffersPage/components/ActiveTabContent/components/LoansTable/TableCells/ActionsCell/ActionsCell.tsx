...
import { useHiddenNftsMints } from '@coopfi/pages/nftLending/OffersPage'
...
import { CreateClaimTxnDataParams, createClaimTxnData } from '@coopfi/transactions/nftLending'
import {
  destroySnackbar,
