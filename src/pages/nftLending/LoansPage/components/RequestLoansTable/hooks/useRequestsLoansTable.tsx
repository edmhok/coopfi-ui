...
import { BorrowTabName, useBorrowTabs } from '@coopfi/pages/nftLending/BorrowPage'
import { REQUEST_LOANS_TABLE_MESSAGES } from '@coopfi/pages/nftLending/LoansPage/constants'
