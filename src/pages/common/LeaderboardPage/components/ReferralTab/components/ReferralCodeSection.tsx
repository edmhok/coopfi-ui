...
import { ReferralInput } from '@coopfi/components/RefferralModal'

import { user } from '@coopfi/api/common'
import { BASE_BANX_URL, DISCORD } from '@coopfi/constants'
import { BanxToken, Copy, Receive } from '@coopfi/icons'
import { defaultTxnErrorHandler } from '@coopfi/transactions'
import { copyToClipboard, enqueueSnackbar } from '@coopfi/utils'
