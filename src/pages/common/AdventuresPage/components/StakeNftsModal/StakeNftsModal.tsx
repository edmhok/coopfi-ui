...
import { TensorFilled } from '@coopfi/icons'
import { useBanxStakeInfo, useBanxStakeSettings } from '@coopfi/pages/common/AdventuresPage'
import { NftCheckbox, NftsStats } from '@coopfi/pages/common/AdventuresPage/components'
...
} from '@coopfi/transactions/staking'
import {
  destroySnackbar,
