...
import { calculateLtvPercent } from '@coopfi/components/PlaceTokenOfferSection'
...
import { ChevronDown, Coin, CoinPlus, Warning } from '@coopfi/icons'
import { useTokenType } from '@coopfi/store/common'
import { convertToSynthetic, useSyntheticTokenOffers } from '@coopfi/store/token'
import {
